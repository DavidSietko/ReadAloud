        ...
        <section className="mb-12 grid gap-6 md:grid-cols-3">
          <div className="rounded-xl border bg-card p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Choose from a variety of natural-sounding voices. Adjust pitch, speed, and tone to
          ...
          <div className="rounded-xl border bg-card p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Ask questions, get explanations, or just chat. Your AI companion understands context
          ...
          <div className="rounded-xl border bg-card p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Import e-books, audiobooks, or paste your own text. Read anything you want with your
              personal companion.
            </p>
          </div>
        </section>
      ...
      <footer className="border-t bg-card mt-12">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <p className="text-sm text-muted-foreground">Making reading accessible for everyone</p>
